...
const TASK_TYPE_PATTERNS: Array<[EssayTaskType, RegExp]> = [
  ...
  [
    "problem_discovery",
    /(?:問題|課題|論点).{0,12}(?:発見|定義|特定|設定|抽出|明らか|挙げ|示し)|(?:発見|定義|特定|設定|抽出).{0,12}(?:問題|課題|論点)|問題点|課題点|本質的な(?:問題|課題)/
  ],
  [
    "solution_design",
    /(?:解決策|改善策|対応策|方策|施策|対策|アイデア|仕組み).{0,12}(?:提案|設計|考案|提示|示し|述べ)|(?:提案|設計|考案|提示).{0,12}(?:方策|施策|対策|アイデア|仕組み)|提案(?:しなさい|せよ|してください|し、|して)|どのように.{0,12}(?:解決|改善)/
  ],
  [
    "quantitative_estimation",
